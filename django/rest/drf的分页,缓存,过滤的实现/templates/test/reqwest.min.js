...
! function (name, context, definition) {
    ...
    var httpsRe = /^http/,
        ...
        function setHeaders(http, o) {
            ...
            if (!headers[contentType] && !isAFormData) headers[contentType] = o['contentType'] || defaultHeaders[
                    'contentType']
            for (h in headers)
        ...
        function getRequest(fn, err) {
            var o = this.o,
                ...
                ,
                data = (o['processData'] !== false && o['data'] && typeof o['data'] !== 'string') ? reqwest.toQueryString(
                    o['data']) : (o['data'] || null),
                http, sendWait = false
    ...
    function serial(el, cb) {
        var n = el.name,
            ...
            optCb = function (o) {
                ...
                if (o && !o['disabled'])
                    cb(n, normalize(o['attributes']['value'] && o['attributes']['value']['specified'] ? o['value'] : o[
                        'text']))
            }, ch, ra, val, i
